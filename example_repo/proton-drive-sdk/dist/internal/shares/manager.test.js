...
describe('SharesManager', () => {
    ...
    describe('getRootIDs', () => {
        ...
        it("should create volume when My files section doesn't exist", async () => {
            apiService.getMyFiles = jest.fn().mockRejectedValue(new apiService_1.NotFoundAPIError('no active volume', 0));
    ...
    describe('getMyFilesShareMemberEmailKey', () => {
        it('should return cached volume email key', async () => {
            jest.spyOn(manager, 'getRootIDs').mockResolvedValue({ volumeId: 'volumeId' });
