...
describe('ThumbnailDownloader', () => {
    ...
    beforeEach(() => {
        ...
        // @ts-expect-error No need to implement all methods for mocking
        apiService = {
            iterateThumbnails: jest.fn().mockImplementation(async function* (thumbnailUids) {
        ...
        // @ts-expect-error No need to implement all methods for mocking
        cryptoService = {
            decryptThumbnail: jest.fn().mockImplementation(async (thumbnail) => thumbnail),
        };
        downloader = new thumbnailDownloader_1.ThumbnailDownloader(telemetry, nodesService, apiService, cryptoService);
    });
...
//# sourceMappingURL=thumbnailDownloader.test.js.map