...
export interface FileUploader {
     ...
     */
    uploadFromStream(stream: ReadableStream, thumnbails: Thumbnail[], onProgress?: (uploadedBytes: number) => void): Promise<UploadController>;
    /**
     ...
     * The function will reject if the node with the given name already exists.
     */
    uploadFromFile(fileObject: File, thumnbails: Thumbnail[], onProgress?: (uploadedBytes: number) => void): Promise<UploadController>;
}
