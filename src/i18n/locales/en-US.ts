export const EN = {
	...
	"authPrompt.title": "Sign in",
	"authPrompt.desc": "Choose a provider and sign in to continue using this feature.",
	"authPrompt.signIn": "Sign in now",
	"providerPicker.title": "Sign in",
	"providerPicker.desc": "Select a provider to open its sign-in flow.",

	"login.title": "Sign in to {provider}",
	"login.subtitle": "Securely sign in and store the session on this device.",
	"login.email": "Email",
	...
	"login.accountStep": "Account",
	"login.verificationStep": "Verification",
	"login.extraSecurityStep": "Extra security",
	...
	"settings.remoteFolderDesc": "Choose the target folder path. Validation runs automatically.",
	...
	"remoteFolder.selectFolderDesc": "Choose a remote folder path.",
